...
public class TinderBoltApp extends MultiSessionTelegramBot {
    public static final String TELEGRAM_BOT_NAME = "tylerTinder_bot"; //TODO: добавь имя бота в кавычках
    public static final String TELEGRAM_BOT_TOKEN = "8215004697:AAH67amIAXaPHEf2YOkn1Ax9W1kHOR8_YbQ"; //TODO: добавь токен бота в кавычках
    ...
    @Override
        ...
        if (message.equals("/gpt")) {
            ...
            sendTextMessage("Напишите свой запрос *ChatGPT*:");
            return;
        }
        ...
        if (currentMode == DialogMode.DATE && !isMessageCommand()) {
            ...
            Message msg = sendTextMessage("Набирает сообщение...");
